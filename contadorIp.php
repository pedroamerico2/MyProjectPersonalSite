<?php
    ...
    class ClassVisitas extends ClassConexao{
        ...
        {
            $Select=$this->Conectar()->prepare("select * from contadorSiteInno where Ip=:ip and Data=:datas order by Id desc");
        ...
        {
            $Select=$this->Conectar()->prepare("insert into contadorSiteInno values (:id , :ip , :datas , :hora)");
